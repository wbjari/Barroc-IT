...
<div class="panel-text">
    <h1>Sales panel: Inactive appointments</h1>
</div>
...
<div class='form-group'>
  ...
  <table class='table table-striped'>
    ...
    while ($row = mysqli_fetch_assoc($r_view)) 
    {
        ...
        echo '<tr>';
        echo '<td><a onclick="reloadPage()" title="Make active" 
              class="btn btn-success" href="../controllers/salesController.php?aid='.$cid . '">
